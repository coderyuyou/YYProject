...
@interface YYHighLightButton : UIButton

@property (strong, nonatomic) UIColor *highlightedColor;

@end

@implementation YYHighLightButton
...
@interface YYAlertAction ()

@property (copy, nonatomic) void(^actionHandler)(YYAlertAction *action);

@end

@implementation YYAlertAction

+ (instancetype)actionWithTitle:(NSString *)title handler:(void (^)(YYAlertAction *action))handler {
    YYAlertAction *instance = [YYAlertAction new];
...
+ (instancetype)alertControllerWithTitle:(NSString *)title message:(NSString *)message {
    ...
    YYAlertViewController *instance = [YYAlertViewController new];
...
- (void)creatContentView {
    ...
    _contentView.backgroundColor = kColorRGBA(0, 0, 0, 0.6);
...
- (void)creatAllButtons {
    ...
    for (int i=0; i<self.actions.count; i++) {
        ...
        YYHighLightButton *btn = [YYHighLightButton new];
        btn.tag = 10+i;
...
- (void)creatAllSeparatorLine {
    ...
    for (int i=0; i<linesAmount; i++) {
        ...
        separatorLine.backgroundColor = kWhiteColor;
...
- (void)updateAllSeparatorLineFrame {
    ...
    for (int i=0; i<linesAmount; i++) {
        ...
        separatorLine.frame = CGRectMake(btn.frame.origin.x, y, _contentViewWidth, 0.5);
    }
}
...
- (void)didClickButton:(UIButton *)sender {
    YYAlertAction *action = self.actions[sender.tag-10];
